...
# ── Content ───────────────────────────────────────────────────────────────────
DEFAULT_TEXT = (
    "There is a simple idea from Atomic Habits that changes how we think about progress. "
    "Most people assume success comes from big dramatic changes. "
    "But the author suggests something different. "
...
DEFAULT_INSTRUCT = (
    "Explain the idea in a calm conversational tone, like you are thinking through the explanation while talking to someone. "
    "Speak at a relaxed pace that is slightly slower than normal reading. "
    "Avoid rushing through sentences. "
    "Use brief natural pauses between ideas so the listener has time to absorb the explanation. "
    "Do not exaggerate emotion or emphasis. "
    "The delivery should feel like a person explaining something thoughtfully in a normal conversation."
)

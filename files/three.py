...
DEFAULT_TEXT = (
    "Thinking, Fast and Slow introduces a fascinating idea about how the human mind works.\n"

    "According to the book, our brain operates using two different systems.\n"

    "The first system is called System One.\n"
    "It works automatically,\n"
    "quickly,\n"
    "and without much effort.\n"

    "For example,\n"
    "when you recognize a familiar face,\n"
    "or instantly understand a simple sentence,\n"
    "System One is doing the work.\n"

    "It is fast,\n"
    "intuitive,\n"
    "and constantly active.\n"

    "The second system works very differently.\n"
    "This is called System Two.\n"

    "System Two is slower,\n"
    "more deliberate,\n"
    "and requires conscious effort.\n"

    "You use System Two when solving a difficult math problem,\n"
    "making an important decision,\n"
    "or carefully analyzing information.\n"

    "Most of the time,\n"
    "our brain prefers to rely on System One,\n"
    "because it saves energy.\n"

    "But this shortcut can sometimes lead to mistakes.\n"

    "The key idea of the book is that understanding these two systems\n"
    "helps us recognize how our decisions are really made."
)

INSTRUCT_3 = ("Explain the idea in a calm conversational tone, like you are discussing it naturally with another person. "

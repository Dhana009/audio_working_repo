...
DEFAULT_TEXT = (
    ...
    "Real change - the kind that actually lasts - comes from tiny improvements, repeated every single day.\n"
...
DEFAULT_INSTRUCT = (
    "You are a warm, thoughtful podcast host who explains book ideas to curious listeners. "
    "Begin with genuine energy and warmth from the very first word, "
    "as if you are leaning in to share something fascinating with a friend. "
    "The opening line should feel inviting and slightly curious - not flat or neutral. "
    "As you move through the explanation, settle into a calm and steady rhythm. "
    "Give extra weight to key phrases like 'one percent', 'compound', and 'stay consistent' - "
    "slow down on those words slightly and let them breathe. "
    "Use the ellipsis in the text as natural breath pauses. "
    "Sound like you believe every word you are saying. "
